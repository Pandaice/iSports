<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="download.aspx.cs" Inherits="iSports.asp.download" %>

<!doctype html>
<html>
        <head>
        <meta charset="utf-8">
        <title>isports-资料下载</title>
...
<div id="nav">
    ...
    <div class="download_file_list">
        ...
        <ul id = "Downloads">
            <%
                  ...
                  {
              %>
                  <li><a href=<% Response.Write(download_item[i, 3]); %> target="_blank"><% Response.Write(download_item[i, 1]); %></a></li>
              <%
                  }
              %>
                </ul>
        当前是：<% Response.Write(page);%>/<% Response.Write(page_num);%>页，共<%Response.Write(download_count);%>条信息
        ...
        <%
                ...
                %>
              <a href="download.aspx">首页</a> <a href="?classid=6593&amp;page=<% Response.Write(page - 1);%>">上一页</a>
              <%
            }
            %>
              <% if(page<page_num){%>
              ...
              <% } %>
              <% if(page<page_num){%>
              <a href="?classid=6599&amp;page=<% Response.Write(page_num);%>">尾页</a>
              <% }else {%>
              <span>尾页</span>
              <% } %>
  
        第
              <select name="PB_Page_Select" onchange="location.href='?classid=6599&amp;page='+this.value">
    ...
    <div class="bg"> <img id="bgImg" class="bg" alt="Background image" src="../images/bg4.jpg" /> </div>
