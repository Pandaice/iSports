<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="my_sign_up.aspx.cs" Inherits="iSports.asp.my_sign_up" %>
<html>
        <head>
        <meta charset="utf-8">
        ...
        <b>个人中心</b> <font>User Center</font>
         ...
         <div class="ser_right_title usetitle">
            <ul>
              ...
              <li><a class="act" href="my_sign_up.aspx">我报名的约球</a></li>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="usr_table2" style="background:none">
    ...
    <tbody>
        <%
            ...
            %>
            <td width="80%" align="left" class="case_name"><span>No.<% Response.Write(sign_up_info[i, 0]); %></span><a href="<% Response.Write("appointment_detail.aspx?a=" + sign_up_info[i, 0]); %>"><% Response.Write(sign_up_info[i, 2]); %></a></td>
            <td align="right"><% Response.Write(sign_up_info[i, 8]); %></td>
            </tr>
    <tr class="proj_cont" style="display: table-row;">
              <td colspan="3"><table class="tab_cont">
                <tbody>
                  <tr class="tr_hidden tr355">
                      <td class="color999"><% Response.Write(sign_up_info[i, 3]); %><br>
                      球类：<% Response.Write(sign_up_info[i, 3]); %>&nbsp;&nbsp;| 发起时间：<% Response.Write(sign_up_info[i, 8]); %> &nbsp;&nbsp;|&nbsp;&nbsp;地点：<% Response.Write(sign_up_info[i, 5]); %>&nbsp;&nbsp;|总人数：<% Response.Write(sign_up_info[i, 6]); %></td>                      
                      <td align="right"><a href="<% Response.Write("appointment_detail.aspx?a=" + sign_up_info[i, 0]); %>" class="xmdj sc_no" style="left: -50px; background:#ed6f1b;">详情</a></td>
                    </tr>
                  <tr class="tr_hidden tr355">
                      <td class="case_info"><% Response.Write(sign_up_info[i, 4]); %></td>
                    </tr> 
                </tbody>
                </table>
              </td>
